        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Login = table.Column<string>(maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectGitHubLink = table.Column<string>(nullable: true),
                    ProjectVideoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Projects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Projects_Videos_ProjectVideoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ProjectVideoId",
                table: "Projects",
